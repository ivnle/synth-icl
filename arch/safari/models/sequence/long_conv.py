...
from arch.safari.models.nn import LinearActivation, Activation, DropoutNd
from arch.safari.models.sequence.block_fft import BlockFFT
from arch.safari.models.sequence.long_conv_kernel import LongConvKernel
...
class LongConv(nn.Module):
    def __init__(
        ...
        **kernel_args,
        ...
        if verbose:
            ...
            log = arch.src.utils.train.get_logger(__name__)
    ...
    ):  # absorbs return_output and transformer safari mask
        """
