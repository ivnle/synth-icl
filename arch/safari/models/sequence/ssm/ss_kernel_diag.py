...
from arch.safari.utils.train import OptimModule
...
from arch.safari.ops.vandermonde import log_vandermonde_fast

try:
    import pykeops
    from arch.safari.ops.vandermonde import log_vandermonde, log_vandermonde_transpose

    has_pykeops = True
    log.info("Pykeops installation found.")
except ImportError:
    has_pykeops = False
    from arch.safari.ops.vandermonde import log_vandermonde_naive as log_vandermonde
    from arch.safari.ops.vandermonde import (
