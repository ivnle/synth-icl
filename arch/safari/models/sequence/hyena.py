...
try:
    from arch.safari.ops.fftconv import fftconv_ref, fftconv_func
except ImportError:
    fftconv_func = None
...
from arch.safari.utils.config import instantiate, auto_assign_attrs
from arch.safari.models.nn import Activation
