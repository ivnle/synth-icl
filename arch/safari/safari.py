...
from arch.safari.utils import instantiate
import arch.safari.utils.registry as registry
import arch.safari.utils as utils
import arch.safari.utils.train
from arch.safari.utils.optim_groups import add_optimizer_hooks

log = arch.safari.utils.train.get_logger(__name__)
...
class SimpleLMHeadModel(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        # self.tie_weights() # perform weight tying in main.py instead of here
    ...
    def configure_optimizers(self, cfg):
        ...
        arch.src.utils.train.log_optimizer(log, optimizer, keys)

        return [optimizer], [None]

        # TODO think about using this code to add schedulers later
        # Configure scheduler
